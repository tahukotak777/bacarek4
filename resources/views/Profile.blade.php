...
<body>
  ...
  <main>
    ...
    <input id="input-small" type="text" value="{{$dataAccount->username}}" disabled />
    <div>
      <label for="">Kata Sandi</label>
    </div>
    <input id="input-small" type="password" value="{{$dataAccount->password}}" disabled />
    <div>
      <label for="">Jenis Kelamin</label>
    </div>
    <select id="input-small" name="" id="" disabled>
      <option value="laki">{{$dataAccount->jenis_kelamin}}</option>
    </select>
    <div class="button-container">
      <a id="editButton" class="upload" href="/Profile/Edit">
        Sunting
      </a>
      <a id="logoutButton" class="upload1" href="/Logout">Keluar</a>
    </div>
  </main>
